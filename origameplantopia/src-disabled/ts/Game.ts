...
export class Game {
    public bga: Bga<OrigamePlantopiaPlayer, OrigamePlantopiaGamedatas>;
    private gamedatas: OrigamePlantopiaGamedatas;

    private playerTurn: PlayerTurn;

    constructor(bga: Bga<OrigamePlantopiaPlayer, OrigamePlantopiaGamedatas>) {
    ...
    */
    ...
    setup(gamedatas: OrigamePlantopiaGamedatas) {
